...
describe('Sidebar', () => {
  ...
  it('should render a div with #efefef backgorund color by default', () => {
    const color = wrapper
      .find('div')
      .children()
      .first()
  ...
  it('should render a div with #eeeeee backgorund color', () => {
